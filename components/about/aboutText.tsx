...
const AboutText = () => {
    return (
        <div className={styles.aboutText}>
            ...
            developer</span> began with learning <span className={styles.AtomBlue}> React </span> . I am a <span
            ...
            className={styles.AtomPurple}> ui </span> design and <span className={styles.AtomOrange}> coding </span> in
            Front.
        </div>
    );
};
